...
public class MainClass11PenduV2AvecArrayList {
	...
	public static void main(String[] args) throws Exception {
		...
		while(readerFichier.hasNextLine()){
			listeMots.add(readerFichier.nextLine());
     	}
		
		double nombreAleatoireEntreZeroEtUn = Math.random();
		int coeff =50000;
		indiceAleatoire = (int) ( nombreAleatoireEntreZeroEtUn * coeff ) % listeMots.size();
		motATrouver=listeMots.get(indiceAleatoire);
		int i;
		...
		//System.out.println("motATrouver (affichage temporaire) : " + motATrouver);
		while(nbLettresRestantATrouver > 0 && nbEssais>0){
